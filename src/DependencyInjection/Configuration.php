...
//region SECTION: Getters/Setters
    ...
    public function getConfigTreeBuilder()
    {
        ...
        $rootNode
            ...
            ->defaultValue('orm')
            ->end()
            ->scalarNode('factory_bind')->cannotBeEmpty()->defaultValue(EvrinomaCodeExtension::FACTORY_BIND)->end()
            ->scalarNode('factory_code')->cannotBeEmpty()->defaultValue(EvrinomaCodeExtension::FACTORY_CODE)->end()
            ->scalarNode('factory_bunch')->cannotBeEmpty()->defaultValue(EvrinomaCodeExtension::FACTORY_BUNCH)->end()
