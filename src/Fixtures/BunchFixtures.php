...
//region SECTION: Fields
    private array $data = [
        ['description' => 'calc estimate', 'type' => 1, 'active' => 'a'],
        ['description' => 'work doc', 'type' => 2, 'active' => 'a'],
        ['description' => 'system', 'type' => 1, 'active' => 'a'],
        ['description' => 'job', 'type' => 2, 'active' => 'a'],
        ['description' => 'career', 'type' => 1, 'active' => 'a'],
        ['description' => 'lib', 'type' => 3, 'active' => 'd'],
    ];
//endregion Fields
